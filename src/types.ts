...
export interface AsyncSeriesWaterfallHook<TArgs extends any[], TResult> {
  tapAsync(name: string, fn: (...args: [...TArgs, (result: TResult) => void]) => Promise<void>): void
...
export type ResolveResult = string | null | undefined
...
export type RenderChunkResult = string | null | undefined
